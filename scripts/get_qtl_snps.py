...
# BAD. DO NOT USE. THE POSITIONS IN bed ARE NOT SNPS.
...
def gsw(file_prefix):
    ...
    fna = os.path.join(
        DANKO_0001, "1000genomes_yrb/consensus/%s_chr.fna" % individual_id
    )
    bed = os.path.join(PATH, "qtl/variable_expression_autosome_hg38_uniq.bed")
    out = os.path.join(PATH, "qtl/qtl_snps/%s.fna" % file_prefix)
