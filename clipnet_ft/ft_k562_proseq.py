...
outdir = Path(f"../models/clipnet_k562_proseq/f{fold}/")
...
model_filepath = str(outdir.joinpath("clipnet_k562_proseq.h5"))
...
csv_logger = CSVLogger(
    filename=outdir.joinpath("clipnet_k562_proseq.log"),
    separator=",",
    append=True,
)
