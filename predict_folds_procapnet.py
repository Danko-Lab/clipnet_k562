...
alt_seqs = [rec.seq for rec in pyfastx.Fasta("data/mpra/k562_mpra_snps_2114_alt.fa.gz")]
alt_ohe = np.array([utils.one_hot_encode(seq) for seq in tqdm.tqdm(alt_seqs)]).swapaxes(1, 2)
