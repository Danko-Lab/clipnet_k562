...
ref_seqs = utils.get_twohot_fasta_sequences("data/mpra/k562_mpra_snps_2114_ref.fa.gz").swapaxes(1, 2) / 2
alt_seqs = utils.get_twohot_fasta_sequences("data/mpra/k562_mpra_snps_2114_alt.fa.gz").swapaxes(1, 2) / 2
...
with h5py.File("data/mpra/k562_mpra_snps_2114_ref_procapnet.h5", "w") as f:
    f.create_dataset("profile", data=ref_profile, compression="gzip")
    f.create_dataset("quantity", data=ref_quantity, compression="gzip")

with h5py.File("data/mpra/k562_mpra_snps_2114_alt_procapnet.h5", "w") as f:
