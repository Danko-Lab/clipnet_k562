...
procapnet_alt = h5py.File(
    "/home2/ayh8/clipnet_k562/data/mpra/k562_mpra_snps_2114_alt_procapnet_folds.h5"
)

mpra = pd.read_csv(
    "/home2/ayh8/clipnet_k562/siraj_mpra/media-4-K562_allelic_mpra.tsv.gz", sep="\t"
)
snps = pd.read_csv(
...
pred = pd.DataFrame(
    {
        ...
        "ref_procapnet_ensemble": procapnet_ref["ref"][:].mean(axis=0),
        "alt_procapnet_ensemble": procapnet_alt["alt"][:].mean(axis=0),
